...
<head>
  ...
  <title>Cómo importar CSV usando PHP Fácil :: Andres Zambrano</title>
...
<nav class="navbar navbar-expand-lg navbar-light navbar-dark fixed-top" style="background-color: #563d7c !important;">
    <ul class="navbar-nav mr-auto collapse navbar-collapse">
      <li class="nav-item active">
        ...
        <strong style="color:#fff;">Importacion Masiva</strong>
        </a>
      </li>
    </ul>
    <div class="my-2 my-lg-0">
      <h5 class="navbar-brand">Importa CVS Andres Zambrano </h5>
    </div>
</nav>
...
<div class="container mb-5">
  <h3 class="text-center">
      Cómo importar <span style="color: #777;">CSV</span> con acentos  usando PHP Fácil
  </h3>
  <hr>
